...
long maxFileSize = userFileUploadsConfiguration.imageMaxSize();
%>

<liferay-portlet:resourceURL copyCurrentRenderParameters="<%= false %>" id="/users_admin/upload_portrait" var="previewURL">
	<portlet:param name="mvcRenderCommandName" value="/users_admin/upload_portrait" />
...
<c:choose>
	...
	<c:otherwise>
		<portlet:actionURL name="/users_admin/upload_portrait" var="uploadImageURL">
			<portlet:param name="mvcRenderCommandName" value="/users_admin/upload_portrait" />
		</portlet:actionURL>
		...
		<aui:script use="liferay-logo-editor">
			<portlet:actionURL name="/users_admin/upload_portrait" var="addTempImageURL">
				<portlet:param name="mvcRenderCommandName" value="/users_admin/upload_portrait" />
