...
public class UploadPortraitMVCActionCommand extends BaseMVCActionCommand {
	...
	protected FileEntry addTempImageFileEntry(PortletRequest portletRequest)
		...
		try {
			TempFileEntryUtil.deleteTempFileEntry(
				...
				UploadPortraitUtil.getTempImageFolderName(), fileName);
		}
		...
		return TempFileEntryUtil.addTempFileEntry(
			themeDisplay.getScopeGroupId(), themeDisplay.getUserId(),
			UploadPortraitUtil.getTempImageFolderName(), fileName, file,
			contentType);
	}
	...
	protected FileEntry saveTempImageFileEntry(ActionRequest actionRequest)
		...
		try {
			FileEntry tempFileEntry = UploadPortraitUtil.getTempImageFileEntry(
				actionRequest);
			...
			try (InputStream tempImageInputStream =
				...
				try {
					TempFileEntryUtil.deleteTempFileEntry(
						...
						UploadPortraitUtil.getTempImageFolderName(),
	...
	private static final Log _log = LogFactoryUtil.getLog(
		UploadPortraitMVCActionCommand.class);
